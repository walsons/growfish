...
int main(int argc, char* argv[])
{
    ...
    else if (argv1 == "speed")  // (Release will be faster)
    {
        ...
        */
        ...
        // =============================   i5-1135G7 (Debug)   ============================= 
        /*
        robot_battle.txt  (depth 4: timecost 1.598s, search nodes 313384)
        robot_battle_1729653504763.txt  (depth 4: timecost 0.13s, search nodes 30080)
        robot_battle_1729666476581.txt  (depth 4: timecost 1.538s, search nodes 391403)
        robot_battle_1729759105954.txt  (depth 4: timecost 0.266s, search nodes 59161)
        robot_battle_1730124987011.txt  (depth 4: timecost 0.684s, search nodes 147499)
        robot_battle_1730130702948.txt  (depth 4: timecost 1.264s, search nodes 261090)
        robot_battle_1730422269049.txt  (depth 4: timecost 1.301s, search nodes 306975)
        robot_battle_1732956559883.txt  (depth 4: timecost 2.536s, search nodes 521695)
        robot_battle_1733750483345.txt  (depth 4: timecost 1.809s, search nodes 375602)
        robot_battle_1733750496914.txt  (depth 4: timecost 2.399s, search nodes 513232)
        robot_battle_1733917013899.txt  (depth 4: timecost 1.429s, search nodes 306033)
        robot_battle_1733917045094.txt  (depth 4: timecost 1.592s, search nodes 300729)
        robot_battle_1733922523712.txt  (depth 4: timecost 3.98s, search nodes 738925)
        robot_battle_1733924013886.txt  (depth 4: timecost 3.316s, search nodes 694360)
        All files cost time is: 23.842s
