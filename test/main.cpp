...
int main(int argc, char* argv[])
{
    ...
    else if (argv1 == "speed")  // (Release will be faster)
    {
        ...
        */
        ...
        // =============================   i5-1135G7 (Debug)   ============================= 
        /*
        robot_battle.txt  (depth 4: timecost 2.319s, search nodes 314888)
        robot_battle_1729653504763.txt  (depth 4: timecost 0.187s, search nodes 30073)
        robot_battle_1729666476581.txt  (depth 4: timecost 2.012s, search nodes 387057)
        robot_battle_1729759105954.txt  (depth 4: timecost 0.367s, search nodes 59183)
        robot_battle_1730124987011.txt  (depth 4: timecost 1.001s, search nodes 148504)
        robot_battle_1730130702948.txt  (depth 4: timecost 1.914s, search nodes 262578)
        robot_battle_1730422269049.txt  (depth 4: timecost 1.989s, search nodes 323080)
        robot_battle_1732956559883.txt  (depth 4: timecost 3.579s, search nodes 538229)
        robot_battle_1733750483345.txt  (depth 4: timecost 2.528s, search nodes 380456)
        robot_battle_1733750496914.txt  (depth 4: timecost 3.106s, search nodes 516491)
        robot_battle_1733917013899.txt  (depth 4: timecost 1.824s, search nodes 296865)
        robot_battle_1733917045094.txt  (depth 4: timecost 2.57s, search nodes 307799)
        robot_battle_1733922523712.txt  (depth 4: timecost 5.346s, search nodes 763184)
        robot_battle_1733924013886.txt  (depth 4: timecost 4.896s, search nodes 715192)
        All files cost time is: 33.638s
