...
{
    (Bitboard(0x40000081004180ULL) << 64) | Bitboard(0x8000401011004000ULL),
    (Bitboard(0x40011014000080ULL) << 64) | Bitboard(0x8082201182402ULL),
    (Bitboard(0x4280010102248080ULL) << 64) | Bitboard(0x40800000080224ULL),
    (Bitboard(0x2140011000800004ULL) << 64) | Bitboard(0x410000080040080ULL),
    (Bitboard(0x100020402200424ULL) << 64) | Bitboard(0x14080000010088ULL),
    (Bitboard(0x40010000101000ULL) << 64) | Bitboard(0x80004010804480ULL),
    (Bitboard(0x4002084800b000ULL) << 64) | Bitboard(0x1200004000004002ULL),
    (Bitboard(0x200008048400102ULL) << 64) | Bitboard(0x5001808002800490ULL),
    (Bitboard(0x40006402a20200ULL) << 64) | Bitboard(0x300000400002008ULL),
    (Bitboard(0x1080400108000280ULL) << 64) | Bitboard(0x210020c080048204ULL),
    (Bitboard(0x290a100006000440ULL) << 64) | Bitboard(0x4a200010200412ULL),
    (Bitboard(0x8080200108008000ULL) << 64) | Bitboard(0x4820000800000410ULL),
    (Bitboard(0x80200200002200ULL) << 64) | Bitboard(0x1000430000500400ULL),
    (Bitboard(0x400c00040480040ULL) << 64) | Bitboard(0xa08000880000040ULL),
    (Bitboard(0x800800010100010ULL) << 64) | Bitboard(0x2002140002020000ULL),
    (Bitboard(0x8000800110300001ULL) << 64) | Bitboard(0x848010021480801ULL),
    (Bitboard(0x18400040028800ULL) << 64) | Bitboard(0x300132008002020ULL),
    (Bitboard(0x2800400084040440ULL) << 64) | Bitboard(0x4208800018100010ULL),
    (Bitboard(0x1202100004114aULL) << 64) | Bitboard(0x8000b02220004004ULL),
    (Bitboard(0x1020800428000ULL) << 64) | Bitboard(0x4000608400000401ULL),
    (Bitboard(0x501201000808000ULL) << 64) | Bitboard(0x860006060040800ULL),
    (Bitboard(0x2402012000880380ULL) << 64) | Bitboard(0x2000010089308020ULL),
    (Bitboard(0x10005000800088ULL) << 64) | Bitboard(0x48004000a0604002ULL),
    (Bitboard(0x8040420008010008ULL) << 64) | Bitboard(0x810200040208000ULL),
    (Bitboard(0x500010004100420ULL) << 64) | Bitboard(0x200210002004c008ULL),
    (Bitboard(0xc208a08000382001ULL) << 64) | Bitboard(0x1012a88000082008ULL),
    (Bitboard(0x981204000260a02ULL) << 64) | Bitboard(0x402120440000000ULL),
    (Bitboard(0x24100008000120ULL) << 64) | Bitboard(0x4080090100001201ULL),
    (Bitboard(0x624080024001100ULL) << 64) | Bitboard(0x1050000050a80001ULL),
    (Bitboard(0x2880008002040ULL) << 64) | Bitboard(0x8401002088040ULL),
    (Bitboard(0x200931008004000ULL) << 64) | Bitboard(0x4410002010a04000ULL),
    (Bitboard(0x982800220004010ULL) << 64) | Bitboard(0x4200820000c4010ULL),
    (Bitboard(0x2000400010004028ULL) << 64) | Bitboard(0x800088040040020ULL),
    (Bitboard(0x2008003a0008210ULL) << 64) | Bitboard(0x4148400201a1100ULL),
    (Bitboard(0x8022002040000104ULL) << 64) | Bitboard(0x840c0040800888ULL),
    (Bitboard(0x204408020000400ULL) << 64) | Bitboard(0x5010202010080008ULL),
    (Bitboard(0x4040000104020002ULL) << 64) | Bitboard(0x4000080a64400080ULL),
    (Bitboard(0x10004001082000bULL) << 64) | Bitboard(0x8220000408004089ULL),
    (Bitboard(0x8028000100230010ULL) << 64) | Bitboard(0x20000090090401ULL),
    (Bitboard(0x2480008100040014ULL) << 64) | Bitboard(0xa000400080000103ULL),
    (Bitboard(0x20b800100100008ULL) << 64) | Bitboard(0x2064101000100000ULL),
    (Bitboard(0x800a42100030ULL) << 64) | Bitboard(0x2008004400014101ULL),
    (Bitboard(0x210400680980004ULL) << 64) | Bitboard(0x882000000002041ULL),
    (Bitboard(0x80e0080200003ULL) << 64) | Bitboard(0x510040b0012402ULL),
    (Bitboard(0x80480b2244100001ULL) << 64) | Bitboard(0x22044000000040ULL),
    (Bitboard(0x48a1208010200ULL) << 64) | Bitboard(0x140018804021088ULL),
    (Bitboard(0x280208800080400ULL) << 64) | Bitboard(0x2020540000029241ULL),
    (Bitboard(0x10001022002200ULL) << 64) | Bitboard(0x10100049c4a00800ULL),
    (Bitboard(0x2040020000202200ULL) << 64) | Bitboard(0x2000400008800022ULL),
    (Bitboard(0x2000820004140200ULL) << 64) | Bitboard(0x44c000001010043ULL),
    (Bitboard(0x8800810600800ULL) << 64) | Bitboard(0x1808180088814412ULL),
    (Bitboard(0x200800082801800ULL) << 64) | Bitboard(0x401802064800528ULL),
    (Bitboard(0xc001009020401000ULL) << 64) | Bitboard(0x300d204001200000ULL),
    (Bitboard(0x1020000490040800ULL) << 64) | Bitboard(0x6c200040c082013ULL),
    (Bitboard(0x170208060001ULL) << 64) | Bitboard(0x100000130200ULL),
    (Bitboard(0x2c70000801000088ULL) << 64) | Bitboard(0x8002040404104001ULL),
    (Bitboard(0xa8001001010001ULL) << 64) | Bitboard(0x8220088002013ULL),
    (Bitboard(0x1044001004809011ULL) << 64) | Bitboard(0x10001000800018ULL),
    (Bitboard(0xd008002c2042084ULL) << 64) | Bitboard(0x8080041200000ULL),
    (Bitboard(0x401080009022ULL) << 64) | Bitboard(0x8008020000009ULL),
    (Bitboard(0x15d08000428c4004ULL) << 64) | Bitboard(0x401c010041000ULL),
    (Bitboard(0x11820004040408ULL) << 64) | Bitboard(0x4008207041000ULL),
    (Bitboard(0x2883d49001200114ULL) << 64) | Bitboard(0x800900200000ULL),
    (Bitboard(0x1040841022020000ULL) << 64) | Bitboard(0x1680003000c20108ULL),
    (Bitboard(0x4c00080004000041ULL) << 64) | Bitboard(0x180040000000a30ULL),
    (Bitboard(0x808006c00008021ULL) << 64) | Bitboard(0x8006000008a300ULL),
    (Bitboard(0x5118182001000020ULL) << 64) | Bitboard(0x900030210000002ULL),
    (Bitboard(0x80200020800010ULL) << 64) | Bitboard(0x180030010080000ULL),
    (Bitboard(0x11000401002000ULL) << 64) | Bitboard(0xc00440100000541ULL),
    (Bitboard(0x400020200021ULL) << 64) | Bitboard(0x100020800001323ULL),
    (Bitboard(0x1004002016802004ULL) << 64) | Bitboard(0x400022291050010ULL),
    (Bitboard(0xc00815208010418ULL) << 64) | Bitboard(0x600001020440080ULL),
    (Bitboard(0x10222c0c10106200ULL) << 64) | Bitboard(0x40800000a18800ULL),
    (Bitboard(0x80020800041050ULL) << 64) | Bitboard(0x4000400010000208ULL),
    (Bitboard(0x5c1112002000100ULL) << 64) | Bitboard(0xa018800000100214ULL),
    (Bitboard(0x80042000448000c0ULL) << 64) | Bitboard(0x284400000008001ULL),
    (Bitboard(0x200028020c001ULL) << 64) | Bitboard(0x43400080082020ULL),
    (Bitboard(0x800041088060ULL) << 64) | Bitboard(0x8805000200220100ULL),
    (Bitboard(0x9e1200811300018ULL) << 64) | Bitboard(0x4000a4001080ULL),
    (Bitboard(0x200900a8180120ULL) << 64) | Bitboard(0x20e000804960000ULL),
    (Bitboard(0x600002401204400ULL) << 64) | Bitboard(0x8081000001000090ULL),
    (Bitboard(0x82014401040000ULL) << 64) | Bitboard(0x924000200001a000ULL),
    (Bitboard(0x60001802000140ULL) << 64) | Bitboard(0x18023000810000ULL),
    (Bitboard(0x800c8200004202ULL) << 64) | Bitboard(0x820002000202100ULL),
    (Bitboard(0xa200010040800084ULL) << 64) | Bitboard(0xe000402000010088ULL),
    (Bitboard(0x20c3400200800028ULL) << 64) | Bitboard(0x1801004000002000ULL),
    (Bitboard(0x40200012200010ULL) << 64) | Bitboard(0x11002000200208ULL),
    (Bitboard(0x1800040024002ULL) << 64) | Bitboard(0x129c048000040040ULL),
    (Bitboard(0x34c20044045407ULL) << 64) | Bitboard(0xc801050000018000ULL),
    (Bitboard(0x2407200000810400ULL) << 64) | Bitboard(0x40082000100082ULL),
};
